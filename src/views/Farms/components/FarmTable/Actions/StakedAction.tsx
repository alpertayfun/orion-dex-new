...
const Staked: React.FunctionComponent<StackedActionProps> = ({
  ...
  const lpTokenPrice = useLpTokenPrice(pid)
  ...
  const displayBalanceValueUSD = useCallback(() => {
    const stakedBalanceNumber = getBalanceNumber(stakedBalance)
    return formatNumber(lpTokenPrice.times(stakedBalanceNumber).toNumber())
  }, [stakedBalance, lpTokenPrice])
        ...
        <ActionContainer>
          ...
          <ActionContent>
            <div>
              ...
              <StakedValue>~${displayBalanceValueUSD()}</StakedValue>
            </div>
            <IconButtonWrapper>
