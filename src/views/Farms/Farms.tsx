...
const Farms: React.FC = () => {
  ...
  const activeFarms = farmsLP.filter((farm) => farm.pid !== 0 && farm.poolWeight && farm.poolWeight !== "0" && !isArchivedPid(farm.pid))
  const inactiveFarms = farmsLP.filter((farm) => farm.pid !== 0 && farm.poolWeight && farm.poolWeight === "0" && !isArchivedPid(farm.pid))
