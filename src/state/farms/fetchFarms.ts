...
const fetchFarms = async (farmsToFetch: FarmConfig[]) => {
  const data = await Promise.all(
    farmsToFetch.map(async (farmConfig) => {
      ...
      return {
        ...farmConfig,
        tokenStakedAmount: tokenAmount.toJSON(),
        quoteTokenStakedAmount: quoteTokenAmount.toJSON(),
        lpTotalSupply: new BigNumber(lpTotalSupply).toJSON(),
        lpTotalQuoteTokenBalance: new BigNumber(quoteTokenBalanceLP).toJSON(),
        lpStakedTotalInQuoteToken: lpTotalInQuoteToken.toJSON(),
